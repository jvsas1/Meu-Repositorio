    ...
    class program
    {
        ...
        private static void ListarSeries()
        {
            ...
            foreach (var serie in lista){
                ...
                Console.WriteLine("#ID {0}: - {1} - {2}",serie.retornaTitulo(), (excluido ? "Excluído*": ""));
            }
        }
        ...
        private static void InserirSerie()
        {
            ...
            Serie novaSerie= new Serie(id: repositorio.ProximoId(), genero:(Genero)entradaGenero,ano:entradaAno,descricao:entradaDescricao);
